...
FILE_INPUT_BOOTLOADER=artifacts/ChargerwalletProBTFW_BL.hex
FILE_INPUT_APP=artifacts/ChargerwalletProBTFW_APP.hex
...
$DIR_UTILS/ota_to_chargerwallet_bin.py $FILE_OUTPUT_ZIP $FILE_OUTPUT_OTA_BIN
